...
Proyek ini tidak hanya melakukan pemodelan matematika, melainkan menyajikan cerita data (*data story*) melalui **5 infografis visual** terintegrasi:
...
5.  **Gambar 5: Ringkasan Insight Utama (`fig5_insight_summary.png`)**
    *   *Insight*: Kartu visual informatif berisi 6 temuan utama proyek untuk audiens umum.
...
└── output_halal/                   # Folder hasil ekspor 5 gambar infografis
```
...
Untuk meregenerasi atau mengekspor 5 gambar infografis visual di atas ke dalam folder `output_halal/`, jalankan perintah berikut dari folder ini:
```bash
