...
| :--- | :--- | :---: | :---: | :--- |
| **I. Kualitas Manifold & Graf** | **10-NN Connectivity Score** | `0.9554` | **`0.9535`** | **Tinggi lebih baik.** Persentase tetangga terdekat di ruang MCA yang berlabel sama. (Skor K-Means bias naik karena menumpuk data di klaster C2). |
